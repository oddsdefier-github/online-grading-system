...
<head>
	<meta charset="utf-8">
	 ...
	 <link rel="stylesheet" href="../../assets/css/admin/mailer.css">
		<link rel="stylesheet" href="../../assets/css/admin/next.css">
	<title>Forgot</title>
</head>
<body>
	<div class="sidebar">
				...
				case 'enter_code':
					...
					<div class="n_form">
						<form class="f_next" method="post" action="forgot1.php?mode=enter_code"> 
							...
							<input class="textbox1" type="text" name="code" placeholder="12345" required><br>
				...
				case 'enter_password':
					...
					<div class="e_form">
						<form class="sub_form" method="post" action="forgot1.php?mode=enter_password"> 
							...
							<input class="textbox2" type="text" name="password" placeholder="Password" required><br>
							<input class="textbox2" type="text" name="password2" placeholder="Confirm Password" required>

							<input class="nxt" type="submit" value="Confirm">
							
						
							<!-- <button class="confirmed" href="../index.php">Login</button> -->
						</form>
						</div>
					<?php
					break;
